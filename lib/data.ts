...
export const cities: City[] = [
  ...
  },
  {
    ...
    stats: [
      { label: "Цена квадратного метра в центре", value: "≈ $2 000+" },
      { label: "Доходность аренды", value: "до 8% в год" },
  ...
  },
  {
    ...
    country: "Грузия",
    countryFlag: "🇬🇪",
    tagline: "Старый город и новые башни у Куры",
    description:
      "Один из самых доступных порогов входа в регионе и мощный туристический поток. Иностранцы покупают недвижимость свободно, сделка оформляется в Доме юстиции за один визит.",
    stats: [
      { label: "Цена квадратного метра", value: "≈ $1 500+" },
      { label: "Доходность аренды", value: "до 10% в год" },
      { label: "Оформление сделки", value: "1 день" },
    ],
    highlight: "Без визы до 1 года — приезжайте и живите",
  },
  {
    slug: "krasnodar",
    name: "Краснодар",
    ...
    country: "Россия",
    countryFlag: "🇷🇺",
    tagline: "Южная столица России",
    description:
      "Один из самых быстрорастущих городов страны: тёплый климат, час до моря и большой выбор новостроек комфорт- и бизнес-класса от крупных застройщиков.",
    stats: [
      { label: "Цена квадратного метра", value: "≈ 120 тыс ₽" },
      { label: "До Чёрного моря", value: "~1,5 часа" },
...
export const INSTAGRAM_HREF = "https://www.instagram.com/dubaiown/";
